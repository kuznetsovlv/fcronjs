 ...
 * @param {boolean} [config#immediate = false] - when immediate = true function calls immediatly if it is possible, in other case it cals after wait ms.
 * @param {Object} [config#context] - context object of function. If context was set it can not be changed or removed.
